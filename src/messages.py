...
logind_failed_on_automatic_reserve_message = """خواستم برات تو {} غذا رزرو کنم، ولی نتونستم توی داینینگت لاگین کنم :(
ممکنه اطلاعاتی که بهم دادی اشتباه باشه، یا اکانتت بسته شده باشه. یه بار خودت امتحان کن ببین می‌تونی لاگین کنی یا نه. اگه همه چی درست بود، به ادمین خبر بده."""
...
username_and_password_not_set_message = """
‼️ برای این که بتونم کد فراموشی غذای امروزت رو بهت بدم، باید یوزرنیم و پسوردت رو بهم بدی تا بتونم وارد سایت بشم.
از منوی اصلی، وارد بخش رزرو غذا شو و روی گزینه‌ی «تنظیم نام کاربری و رمز عبور» کلیک کن."""
...
automatic_reserve_not_enabled_message = "رزرو خودکار رو هنوز فعال نکردی. اول اونو فعال کن، بعد بیا و روزهایی که می‌خوای واست غذا رزرو کنم رو بهم بگو."
...
food_court_days_choosed_message = "اگه کارت تموم شد حله رو بزن تا تغییراتت رو سیو کنم، یا یه سلف دیگه رو انتخاب کن."
...
# من سه‌شنبه و چهارشنبه شب‌ها غذا رزرو می‌کنم، پس اگه امروز چهارشنبه نیست، من فردا شب بازم سعی می‌کنم برات غذا بگیرم. ولی اگه امروز چهارشنبه‌ست، دیگه من غذا نمی‌گیرم و باید خودت غذا بگیری."""
reserve_was_failed_message = """Reservation failed error
user_id: {}
food_court: {}
food_court_id: {}
message: {}"""
...
already_reserved_message = "مثل این که قبلا خودت غذاتو توی «{}» رزرو کردی. اگه اینطوری نیست و فکر می‌کنی مشکلی پیش اومده، به ادمین بگو."
...
dining_connection_error_message = "📡 یه مشکلی تو وصل شدن به سایت داینینگ پیش اومده. به خاطر همین نتونستم وارد سایت بشم. لطفا چند دقیقه‌ی دیگه دوباره امتحان کن."

no_food_schedule_on_this_court_for_you_message = """❌ توی سلف «{}» هیچ برنامه‌ی غذایی‌ای برات پیدا نکردم. به نظر میاد که امکان رزرو نداری. خودت یه بررسی بکن ببین مشکل چیه. اگه برنامه غذایی تو سایت برات وجود داره، به ادمین اطلاع بده."""

unkonw_meal_type = "نمی‌دونم :)"
forget_code_list_message = """
🕰 {}
📍 {}
🍟 {}
{}"""