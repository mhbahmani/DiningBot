...
"""
reserve_was_failed_message = "یه مشکلی توی رزرو غذای هفته‌ی بعدت توی «{}» به وجود اومد. لطفا یه سر به سایت داینینگ بزن و چک کن غذایی رزرو نشده باشه، یا این که به اندازه‌ی کافی موجودی داشته باشی. من دوشنبه، سه‌شنبه و چهارشنبه شب‌ها غذا رزرو می‌کنم، پس اگه امروز چهارشنبه نیست، من فردا شب بازم سعی می‌کنم برات غذا بگیرم. ولی اگه امروز چهارشنبه، دیگه من غذا نمی‌گیرم و باید غذاتو خودت بگیری..."
