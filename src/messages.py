...
you_dont_have_food_for_next_week_message = """خواستم بگم غذای هفته‌ی بعدت احتمالا به خاطر این که تو سه روز گذشته اعتبار نداشته اکانتت، رزرو نشده. گشنه نمونی شریفی :) برو غذاتو رزرو کن
