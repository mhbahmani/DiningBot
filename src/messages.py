start_message = """
🍕 غذا می‌قولی؟!
روی /help کلیک کن تا توضیحات مربوط به رزرو خودکار غذا رو ببینی 
"""
...
🟢 من هر هفته، دوشنبه و سه‌شنبه و چهارشنبه غذا رزرو می‌کنم، قبلش هم یه خبر می‌دم بهت که اعتبار اکانتت رو چک کنی که یه وقت توی خرید مشکلی پیش نیاد. بعد از رزرو هم، نتیجه رو بهت اعلام می‌کنم.
"""
...
"""
reserve_was_failed_message = "یه مشکلی توی رزرو غذای هفته‌ی بعدت توی «{}» به وجود اومد. لطفا یه سر به سایت داینینگ بزن و چک کن غذایی رزرو نشده باشه، یا این که به اندازه‌ی کافی موجودی داشته باشی. دو ساعت دیگه دوباره سعی می‌کنم برات غذا بگیرم."
