...
no_day_choosed_for_any_food_court_messsage = "روزی رو برای هیچ سلفی انتخاب نکردی. اگه می‌خوای فقط برای بعضی از روزها غذا بگیری، دوباره روی گزینه‌ی انتخاب روزهای هفته کلیک کن."