...
GIVE_USER_TODAY_RESERVE_FORGET_CODE_LABEL = "کد غذاهای امروزم رو بده"
GIVE_USER_TODAY_RESERVE_FORGET_CODE_REGEX = '^{}$'.format(GIVE_USER_TODAY_RESERVE_FORGET_CODE_LABEL)
...
FORGET_CODE_MENU_CHOICES = [
    [GET_FORGET_CODE_LABEL, GIVE_FORGET_CODE_LABEL, GIVE_USER_TODAY_RESERVE_FORGET_CODE_LABEL],
